...
%%%%%%%%%%%%%%%%%%%%%% VORSPANN %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	% Kurzfassung				
	\include{./0_Vorspann/1_Kurzfassung}								
	% Abkürzungen
	\include{./0_Vorspann/2_Abkuerzungen}								
	% Erklärung
	\include{./0_Vorspann/3_Erklaerung}
	
	% Danksagung (optional)
	\include{./0_Vorspann/4_Danksagung}	
...
%%%%%%%%%%%%%%%%%%% HAUPTTEIL %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\include{./1_Einleitung/1}						
	\include{./2_Theoretische_Grundlagen/2}
	\include{./3_Stand_der_Forschung/3}
	\include{./4_Implementierung_des_Plugin/4}
	\include{./5_Evaluation/5}
	\include{./6_Fazit_und_Ausblick/6}
